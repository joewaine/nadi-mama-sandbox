...
const postOloOrderStreet = (req, resData, res) => {
  ...
  try {
    if (resData.result === "success") {
      ...
      htmlBody =
        htmlBody +
        emailTemplateHelpers.fNameAndConfirmCode(
      ...
      htmlBody =
        htmlBody +
        `</ul><br><p style="text-align: center;margin: 0 auto;width: 100%;">Thank you, Your friends at Mamnoon Street.<br><br><br><a href="https://nadimama.com">nadimama.com</a>${phoneNumber}</p>`;
...
module.exports = { postOloOrderStreet };